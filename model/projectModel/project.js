...
const Project = sequelize.define(
  "Project",
  {
    ...
    milestones: {
      ...
      allowNull: true,
      comment:
        "Array of project milestones [{name, description, deadline, status, completedDate}]",
    },
    ...
    risks: {
      ...
      allowNull: true,
      comment:
        "Array of identified risks [{description, severity, mitigation, status}]",
    },
    issues: {
      type: DataTypes.JSON,
      allowNull: true,
      comment:
        "Array of current issues [{description, priority, assignedTo, status}]",
    },
